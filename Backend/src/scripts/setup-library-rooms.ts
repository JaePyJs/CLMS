...
/**
 * Setup Library Rooms Script for CLMS
 *
 * This script sets up the specific room tracking for your library:
 * - 3 PCs for individual tracking
 * - 1 AVR room for studying
 * - 1 Recreational room (chess/playstation)
 */
...
async function setupLibraryRooms() {
  ...
  try {
    ...
    // 4. Create equipment for PCs (individual tracking)
    ...
    // 5. Create rooms (AVR and Recreational)
    ...
    // 7. Create sample books (minimal collection)
