...
export class AuthService {
  ...
  async login(username: string, password: string): Promise<LoginResult> {
    try {
      ...
      logger.error('Login error', { error: (error as Error).message, username })
      return {
        success: false,
  ...
  async createUser(userData: {
    ...
    try {
      ...
      logger.error('Create user error', { error: (error as Error).message, username: userData.username })
      return {
        success: false,
  ...
  async resetPassword(userId: string, newPassword: string): Promise<{ success: boolean; error?: string }> {
    try {
      ...
      logger.error('Reset password error', { error: (error as Error).message, userId })
      return {
        success: false,
  ...
  async getUserById(userId: string): Promise<any | null> {
    try {
      ...
      logger.error('Get user by ID error', { error: (error as Error).message, userId })
      throw error
    }
  }
  ...
  async updateUser(userId: string, updateData: {
    ...
    try {
      ...
      logger.error('Update user error', { error: (error as Error).message, userId })
      return {
        success: false,
  ...
  async deleteUser(userId: string): Promise<{ success: boolean; error?: string }> {
    try {
      ...
      logger.error('Delete user error', { error: (error as Error).message, userId })
      return {
        success: false,
