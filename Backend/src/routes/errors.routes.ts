...
router.get(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      const dashboard = await errorReportingService.getErrorDashboard(
        timeframe as any,
      );
...
router.post(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      await errorReportingService.resolveError(
        id,
        userId as string,
        resolutionNotes,
      );
...
router.post(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      await errorReportingService.assignError(
        id,
...
router.get(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      const exportData = await errorReportingService.exportErrorReports(
        filters,
        format as any,
      );
...
router.get(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      const history =
        await errorNotificationService.getNotificationHistory(limit);
