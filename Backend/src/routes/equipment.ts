...
router.get('/', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error fetching equipment', { error: (error as Error).message, query: req.query })
    res.status(500).json({
      success: false,
...
router.get('/:id', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error fetching equipment', { error: (error as Error).message, id: req.params.id })
    res.status(500).json({
      success: false,
      error: 'Internal server error',
      message: (error as Error).message,
...
router.post('/', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error creating equipment', { error: (error as Error).message, body: req.body })
    res.status(500).json({
      success: false,
      error: 'Internal server error',
      message: (error as Error).message,
...
router.put('/:id', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error updating equipment', { error: (error as Error).message, id: req.params.id, body: req.body })
    res.status(500).json({
      success: false,
      error: 'Internal server error',
      message: (error as Error).message,
...
router.delete('/:id', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error deleting equipment', { error: (error as Error).message, id: req.params.id })
    res.status(500).json({
      success: false,
      error: 'Internal server error',
      message: (error as Error).message,
...
router.post('/scan', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error scanning equipment barcode', { error: (error as Error).message, body: req.body })
    res.status(500).json({
      success: false,
      error: 'Internal server error',
      message: (error as Error).message,
...
router.post('/use', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error using equipment', { error: (error as Error).message, body: req.body })
    res.status(500).json({
      success: false,
      error: 'Internal server error',
      message: (error as Error).message,
...
router.post('/release', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error releasing equipment', { error: (error as Error).message, body: req.body })
    res.status(500).json({
      success: false,
      error: 'Internal server error',
      message: (error as Error).message,
...
router.get('/usage/history', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error fetching equipment usage history', { error: (error as Error).message, query: req.query })
    res.status(500).json({
      success: false,
      error: 'Internal server error',
      message: (error as Error).message,
...
router.get('/statistics', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error fetching equipment statistics', { error: (error as Error).message })
    res.status(500).json({
      success: false,
      error: 'Internal server error',
      message: (error as Error).message,
