...
router.get('/', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error fetching books', { error: (error as Error).message, query: req.query })
    res.status(500).json({
      success: false,
...
router.get('/:id', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error fetching book', { error: (error as Error).message, id: req.params.id })
    res.status(500).json({
      success: false,
      error: 'Internal server error',
      message: (error as Error).message,
...
router.post('/', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error creating book', { error: (error as Error).message, body: req.body })
    res.status(500).json({
      success: false,
      error: 'Internal server error',
      message: (error as Error).message,
...
router.put('/:id', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error updating book', { error: (error as Error).message, id: req.params.id, body: req.body })
    res.status(500).json({
      success: false,
      error: 'Internal server error',
      message: (error as Error).message,
...
router.delete('/:id', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error deleting book', { error: (error as Error).message, id: req.params.id })
    res.status(500).json({
      success: false,
      error: 'Internal server error',
      message: (error as Error).message,
...
router.post('/scan', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error scanning book barcode', { error: (error as Error).message, body: req.body })
    res.status(500).json({
      success: false,
      error: 'Internal server error',
      message: (error as Error).message,
...
router.post('/checkout', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error checking out book', { error: (error as Error).message, body: req.body })
    res.status(500).json({
      success: false,
      error: 'Internal server error',
      message: (error as Error).message,
...
router.post('/return', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error returning book', { error: (error as Error).message, body: req.body })
    res.status(500).json({
      success: false,
      error: 'Internal server error',
      message: (error as Error).message,
...
router.get('/checkouts/all', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error fetching book checkouts', { error: (error as Error).message, query: req.query })
    res.status(500).json({
      success: false,
      error: 'Internal server error',
      message: (error as Error).message,
...
router.get('/checkouts/overdue', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error fetching overdue books', { error: (error as Error).message })
    res.status(500).json({
      success: false,
      error: 'Internal server error',
      message: (error as Error).message,
