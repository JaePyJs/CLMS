...
export class ImportError extends BaseError {
  public readonly importErrors: Array<{ row: number; field?: string; message: string; value?: any }>
  public readonly partialSuccess: boolean

  constructor(message: string, importErrors: Array<{ row: number; field?: string; message: string; value?: any }>, partialSuccess: boolean = false) {
