...
class GoogleSheetsService {
    ...
    async initialize() {
        ...
        try {
            ...
            const credentialsPath = process.env.GOOGLE_CREDENTIALS_PATH || (0, path_1.join)(process.cwd(), 'google-credentials.json');
            ...
            logger_1.logger.error('Failed to initialize Google Sheets service', { error: error.message });
            throw error;
        }
    }
    async testConnection() {
        try {
            ...
            logger_1.logger.error('Google Sheets connection test failed', { error: error.message });
            return false;
        }
    }
    async healthCheck() {
    ...
    async syncAllData() {
        try {
            ...
            logger_1.logger.error('Google Sheets sync failed', { error: error.message });
            return {
                success: false,
                error: error.message
            };
    ...
    async syncStudents() {
        try {
            ...
            logger_1.logger.error('Failed to sync students to Google Sheets', { error: error.message });
            return {
                success: false,
                error: error.message
            };
    ...
    async syncBooks() {
        try {
            ...
            logger_1.logger.error('Failed to sync books to Google Sheets', { error: error.message });
            return {
                success: false,
                error: error.message
            };
    ...
    async syncEquipment() {
        try {
            ...
            logger_1.logger.error('Failed to sync equipment to Google Sheets', { error: error.message });
            return {
                success: false,
                error: error.message
            };
    ...
    async syncActivities() {
        try {
            ...
            logger_1.logger.error('Failed to sync activities to Google Sheets', { error: error.message });
            return {
                success: false,
                error: error.message
            };
    ...
    async syncBookCheckouts() {
        try {
            ...
            logger_1.logger.error('Failed to sync book checkouts to Google Sheets', { error: error.message });
            return {
                success: false,
                error: error.message
            };
    ...
    async updateSheet(sheetName, headers, rows) {
        try {
            ...
            logger_1.logger.error(`Failed to update Google Sheets: ${sheetName}`, { error: error.message });
            throw error;
        }
    }
    async getSheetData(sheetName, range) {
        try {
            ...
            logger_1.logger.error(`Failed to get data from Google Sheets: ${sheetName}`, { error: error.message });
            throw error;
        }
    }
    async getSpreadsheetInfo() {
        try {
            ...
            logger_1.logger.error('Failed to get spreadsheet info', { error: error.message });
            throw error;
        }
    }
    async generateDailyReport(date) {
        try {
            ...
            logger_1.logger.error('Failed to generate daily report', { error: error.message });
    ...
    async logAutomationTask(taskType, status, message, data) {
        try {
            ...
            logger_1.logger.error('Failed to log automation task', { error: error.message });
        }
    }
