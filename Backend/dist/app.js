...
class CLMSApplication {
    ...
    async initialize() {
        ...
        try {
            ...
            logger_1.logger.error('Failed to initialize CLMS Application', { error: error.message });
            throw error;
        }
    }
    ...
    async initializeServices() {
        ...
        try {
            ...
            logger_1.logger.warn('Failed to initialize automation service', { error: error.message });
        }
        try {
            ...
            logger_1.logger.warn('Google Sheets initialization failed', { error: error.message });
        }
    ...
    async healthCheck(req, res) {
        try {
            ...
            const allServicesHealthy = databaseHealth.connected &&
                googleSheetsHealth.connected &&
                automationHealth.initialized;
