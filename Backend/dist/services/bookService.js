...
async function getBooks(options = {}) {
    try {
        ...
        logger_1.logger.error('Error fetching books', { error: error.message, options });
        throw error;
    }
}
async function getBookById(id) {
    try {
        ...
        logger_1.logger.error('Error fetching book by ID', { error: error.message, id });
        throw error;
    }
}
async function getBookByAccessionNo(accessionNo) {
    try {
        ...
        logger_1.logger.error('Error fetching book by accession number', { error: error.message, accessionNo });
        throw error;
    }
}
async function getBookByIsbn(isbn) {
    try {
        ...
        logger_1.logger.error('Error fetching book by ISBN', { error: error.message, isbn });
        throw error;
    }
}
async function createBook(data) {
    try {
        ...
        logger_1.logger.error('Error creating book', { error: error.message, data });
        throw error;
    }
}
async function updateBook(id, data) {
    try {
        ...
        logger_1.logger.error('Error updating book', { error: error.message, id, data });
        throw error;
    }
}
async function deleteBook(id) {
    try {
        ...
        logger_1.logger.error('Error deleting book', { error: error.message, id });
        throw error;
    }
}
async function checkoutBook(data) {
    try {
        ...
        logger_1.logger.error('Error checking out book', { error: error.message, data });
        throw error;
    }
}
async function returnBook(checkoutId) {
    try {
        ...
        if (returnDate > checkout.dueDate) {
            overdueDays = Math.ceil((returnDate.getTime() - checkout.dueDate.getTime()) / (1000 * 60 * 60 * 24));
        ...
        logger_1.logger.error('Error returning book', { error: error.message, checkoutId });
        throw error;
    }
}
async function getBookCheckouts(options = {}) {
    try {
        ...
        logger_1.logger.error('Error fetching book checkouts', { error: error.message, options });
        throw error;
    }
}
