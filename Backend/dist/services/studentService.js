...
async function getStudentByBarcode(barcode) {
    try {
        ...
        logger_1.logger.error('Error fetching student by barcode', { error: error.message, barcode });
        throw error;
    }
}
async function getStudents(options = {}) {
    try {
        ...
        logger_1.logger.error('Error fetching students', { error: error.message, options });
        throw error;
    }
}
async function createStudent(data) {
    try {
        ...
        logger_1.logger.info('Student created successfully', { studentId: student.studentId });
        return student;
    }
    catch (error) {
        logger_1.logger.error('Error creating student', { error: error.message, data });
        throw error;
    }
}
async function updateStudent(studentId, data) {
    try {
        ...
        logger_1.logger.error('Error updating student', { error: error.message, studentId, data });
        throw error;
    }
}
async function deleteStudent(studentId) {
    try {
        ...
        logger_1.logger.error('Error deleting student', { error: error.message, studentId });
        throw error;
    }
}
async function getStudentActivities(options = {}) {
    try {
        ...
        logger_1.logger.error('Error fetching student activities', { error: error.message, options });
        throw error;
    }
}
...
async function createStudentActivity(data) {
    try {
        ...
        logger_1.logger.error('Error creating student activity', { error: error.message, data });
        throw error;
    }
}
async function endStudentActivity(activityId) {
    try {
        ...
        logger_1.logger.error('Error ending student activity', { error: error.message, activityId });
        throw error;
    }
}
