...
async function getEquipment(options = {}) {
    try {
        ...
        logger_1.logger.error('Error fetching equipment', { error: error.message, options });
        throw error;
    }
}
async function getEquipmentById(id) {
    try {
        ...
        logger_1.logger.error('Error fetching equipment by ID', { error: error.message, id });
        throw error;
    }
}
async function getEquipmentByEquipmentId(equipmentId) {
    try {
        ...
        logger_1.logger.error('Error fetching equipment by equipment ID', { error: error.message, equipmentId });
        throw error;
    }
}
async function createEquipment(data) {
    try {
        ...
        logger_1.logger.info('Equipment created successfully', { equipmentId: equipment.equipmentId });
        return equipment;
    }
    catch (error) {
        logger_1.logger.error('Error creating equipment', { error: error.message, data });
        throw error;
    }
}
async function updateEquipment(id, data) {
    try {
        ...
        logger_1.logger.error('Error updating equipment', { error: error.message, id, data });
        throw error;
    }
}
async function deleteEquipment(id) {
    try {
        ...
        logger_1.logger.error('Error deleting equipment', { error: error.message, id });
        throw error;
    }
}
async function useEquipment(data) {
    try {
        ...
        const endTime = new Date(startTime.getTime() + (data.timeLimitMinutes || equipment.maxTimeMinutes) * 60000);
        ...
        logger_1.logger.error('Error using equipment', { error: error.message, data });
        throw error;
    }
}
async function releaseEquipment(activityId) {
    try {
        ...
        logger_1.logger.error('Error releasing equipment', { error: error.message, activityId });
        throw error;
    }
}
async function getEquipmentUsageHistory(options = {}) {
    try {
        ...
        logger_1.logger.error('Error fetching equipment usage history', { error: error.message, options });
        throw error;
    }
}
