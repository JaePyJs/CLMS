  ...
  return (
    <div className="absolute inset-0 overflow-hidden">
      ...
      <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="checkerboard" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
            {/* Dark squares */}
            ...
            {/* Grid lines */}
            <line x1="0" y1="40" x2="80" y2="40" stroke="#4A0E0E" strokeWidth="1" />
            <line x1="40" y1="0" x2="40" y2="80" stroke="#4A0E0E" strokeWidth="1" />
          </pattern>
        </defs>
