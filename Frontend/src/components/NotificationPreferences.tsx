      ...
      <div className="bg-card rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        {saving && (
          <div className="mb-4 p-3 bg-blue-500/10 border border-blue-500/30 rounded-lg flex items-center gap-2">
            ...
            <span className="text-sm text-blue-300">Saving preferences...</span>
          </div>
        )}
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between p-3 bg-muted rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-foreground">Overdue Notices</p>
                  <p className="text-sm text-muted-foreground">
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center justify-between p-3 bg-muted rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-foreground">Fine Alerts</p>
                <p className="text-sm text-muted-foreground">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                preferences.fineAlerts ? 'bg-primary' : 'bg-muted-foreground/30'
              }`}
            >
              <span
                className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between p-3 bg-muted rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-foreground">Account Alerts</p>
                  <p className="text-sm text-muted-foreground">
        ...
        {preferences.emailNotifications && (
          <div className="mb-6">
            <button
              ...
              className="w-full p-3 bg-primary/10 border border-primary/30 rounded-lg hover:bg-primary/20 transition-colors flex items-center justify-center gap-2"
            >
              <Mail className="w-5 h-5 text-primary" />
              <span className="text-primary font-medium">Send Test Email</span>
            </button>
          </div>
        )}
