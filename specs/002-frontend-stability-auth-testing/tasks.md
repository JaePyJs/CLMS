...
- [ ] T001 Create .gitignore with Node.js/TypeScript patterns (node_modules/, dist/, .env*, *.log)
- [ ] T002 Create .eslintignore (node_modules/, dist/, build/, coverage/)
- [ ] T003 [P] Create ErrorBoundary component in Frontend/src/components/ErrorBoundary.tsx
- [ ] T004 [P] Create ErrorFallback UI component in Frontend/src/components/ErrorFallback.tsx
- [ ] T005 [P] Update Vite config to handle errors gracefully in Frontend/vite.config.ts
- [ ] T006 [P] Create error logging utility in Frontend/src/utils/errorLogger.ts
...
- [ ] T007 Wrap App.tsx with root-level ErrorBoundary in Frontend/src/App.tsx
- [ ] T008 [P] Create route-level error boundaries in Frontend/src/components/RouteErrorBoundary.tsx
- [ ] T009 [P] Add window error event handlers in Frontend/src/main.tsx
- [ ] T010 [P] Add unhandledrejection handlers for promises in Frontend/src/main.tsx

### Authentication Infrastructure (Security + Type Safety)

- [ ] T011 Create shared auth types in Frontend/src/types/auth.ts (User, AuthState, JWTPayload)
- [ ] T012 [P] Create Zod validation schemas in Frontend/src/schemas/authSchema.ts (login, register)
- [ ] T013 [P] Create API client utility in Frontend/src/utils/apiClient.ts (JWT token injection)
- [ ] T014 [P] Create token storage utility in Frontend/src/utils/tokenStorage.ts (localStorage/sessionStorage)
- [ ] T015 [P] Add token refresh interceptor in Frontend/src/utils/apiClient.ts
...
- [ ] T018 [P] Create Toast notification system in Frontend/src/components/Toast.tsx
...
- [ ] T021 [US1] Add try-catch to AuthContext.checkAuth() in Frontend/src/contexts/AuthContext.tsx
- [ ] T022 [US1] Add try-catch to AuthContext.login() in Frontend/src/contexts/AuthContext.tsx
- [ ] T023 [US1] Add try-catch to AuthContext.logout() in Frontend/src/contexts/AuthContext.tsx
- [ ] T024 [US1] Add try-catch to AuthContext.refreshToken() in Frontend/src/contexts/AuthContext.tsx

**React Error Boundary Integration**:

- [ ] T025 [US1] Wrap Router with RouteErrorBoundary in Frontend/src/App.tsx
